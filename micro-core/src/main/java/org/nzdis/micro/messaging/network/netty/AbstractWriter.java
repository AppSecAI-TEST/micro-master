...
public abstract class AbstractWriter extends Thread {
    ...
    public void shutdown() {
        ...
        Enumeration<String> it = NettyNetworkConnector.getInstance().connections.keys();
        ...
        while (it.hasMoreElements()) {
            channelFuture = NettyNetworkConnector.getInstance().connections.remove(ConnectionID.inflate(it.nextElement())).getChannel().getCloseFuture();
            ...
            it = NettyNetworkConnector.getInstance().connections.keys();
        }
