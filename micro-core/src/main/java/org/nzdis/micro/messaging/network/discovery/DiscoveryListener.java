...
import pl.edu.agh.jkolodziej.micro.agent.helpers.ConcurrentHashMapHelper;
...
public abstract class DiscoveryListener extends Thread {
    ...
    void actionOnRemotePackage(DatagramPacket packet, String port, String platformID) {
        ...
        ConcurrentHashMapHelper<String, Boolean> helper = new ConcurrentHashMapHelper<String, Boolean>();
        if (!helper.contains(MTRuntime.getPropagatedNodes(), initTarget.toString())
    ...
    void actionOnLocalPackage(DatagramPacket packet, String port) {
        ...
        while (it.hasNext()) {
            ...
            ConcurrentHashMapHelper<String, Boolean> helper = new ConcurrentHashMapHelper<String, Boolean>();
            if (helper.contains(MTRuntime.getPropagatedNodes(), tgtAddress.toString())) {
