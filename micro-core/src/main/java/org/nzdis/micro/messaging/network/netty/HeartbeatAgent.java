        ...
        while (running) {
            ...
            if (running) {
                if (!NettyNetworkConnector.getInstance().connections.isEmpty()) {
                    ...
                    Enumeration<String> connIt = NettyNetworkConnector.getInstance().connections.keys();
                    while (connIt.hasMoreElements()) {
                        String stringId = connIt.nextElement();
                ...
                Enumeration<String> it = heartbeatRegister.keys();
                ...
                while (it.hasMoreElements()) {
                    String tmpConnID = it.nextElement();
